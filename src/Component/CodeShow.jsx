    ...
    <>
      <div className="editContainer">
        <Editor
          ...
          value={html}
          onChange={setHtml}
          icon="https://media.istockphoto.com/id/1206193220/vector/code-programming-icon-vector-isolated-contour-symbol-illustration.jpg?s=612x612&w=0&k=20&c=V2VcVGExSeQYPPVEGOdzQ87NQ7Tl3kBQid2kQpwdlt4="
          color="#FF3C41"
        />
        <Editor
          language="css"
          ...
          value={css}
          onChange={setCss}
          icon="https://e7.pngegg.com/pngimages/889/394/png-clipart-the-daily-dot-internet-online-newspaper-reddit-others-text-logo.png"
          color="#0EBEFF"
        />
        <Editor
          language="javascript"
